        ...
        <article class="prose prose-lg prose-slate max-w-none">
          ...
          >
            ...
            <div
              ...
              class="bg-[#74acdf]/10 border-l-4 border-[#74acdf] rounded-r-xl p-6 my-8"
            >
              <div class="flex gap-3">
                <UIcon
                  name="i-lucide-lightbulb"
                  class="text-[#74acdf] text-xl shrink-0"
                />
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-[#74acdf]">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-6">
          Probá el mejor buscador de jurisprudencia
        </h2>
        <p class="text-lg text-white/90 mb-8">
          SAIJ + CSJN + JUBA + JUSCABA en una sola búsqueda. Gratis para empezar.
        </p>
        <NuxtLink to="/">
          <UButton
            size="xl"
...
const page = guidePages['mejor-buscador-jurisprudencia-argentina']
...
useHead({
  link: [
    { rel: 'canonical', href: 'https://juridica.ar/mejor-buscador-jurisprudencia-argentina' }
  ]
})
  ...
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        'mainEntityOfPage': {
          '@type': 'WebPage',
          '@id': 'https://juridica.ar/mejor-buscador-jurisprudencia-argentina'
        }
      })
    },
    {
