...
// SEO Meta - noindex para pagina privada
useSeoMeta({
  title: 'Mi Perfil | Juridica',
  description: 'Administra tu cuenta, suscripcion y reportes guardados.',
            ...
            <div>
              ...
              <UCard>
                <div class="space-y-4">
                  ...
                  <USeparator />
                  <div class="flex items-center justify-between">
                    <span class="text-sm text-muted">Vencimiento</span>
                    <span class="text-sm font-medium text-highlighted">
                      {{ profile.plan.expiresAt ? formatDate(profile.plan.expiresAt) : 'Sin vencimiento' }}
                    </span>
                  </div>
                </div>
              </UCard>
